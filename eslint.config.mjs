...
export default tseslint.config(
  ...
  // -------------------------------------------------------------------------
  // Layering: only `lib/queries/**` may touch the database.
  // -------------------------------------------------------------------------
  {
          ...
          patterns: [
            {
              ...
              message:
                'Only lib/queries/** may reach the database. Add a query function there and call it. See .claude/rules/data-access.md.',
            },
            {
              group: ['../*', '../../*', '../../../*'],
              message:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    rules: {
      ...
      // An error rather than the plugin's default warning: a stale closure in
      // a save/effect path is exactly the class of bug that survives review
      // and shows up later as "my edit didn't save".
