...
description: This block based puzzle game consists of a size-adjustable game with various pieces, all of which can move in only certain directions. The aim of the game is to get the red target piece through the black exit.
author: Chris Pyle
categories: [Java]
tags: [Project]
pin: true
