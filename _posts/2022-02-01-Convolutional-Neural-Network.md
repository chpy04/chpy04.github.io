...
description: This convolutional nerual network was built froms scratch in python using exclusively math libraries. It features both dense and convolution layers that use backpropogation calculus and gradient descent. The project was tested on the mnist handwritten number dataset, and achieved an accuracy of 97.98%.
author: Chris Pyle
categories: [Python]
tags: [Project]
pin: true
...
![image](/assets/img/learningRates.png)
...
![image](/assets/img/denseNeurons.png)
