---
title: Maze Solver
description: This Maze solver is able to randomly generate mazes and then display a solution in said maze using either breadth first or depth first search. It supports both square and hexagonal mazes, and also allows the user to traverse the maze.
author: Chris Pyle
categories: [Java]
tags: [Project]
pin: true
...
![image](/assets/img/mostlyVertical.png){: width="375" .left} ![image](/assets/img/vertical.png){: width="375" .right}
...
![image](/assets/img/distFromStart.png){: width="375" .left} ![image](/assets/img/distFromEnd.png){: width="375" .right}
<br /><br /><br /><br /><br /><br /><br /><br /><br />
...
![gif](/assets/img/hexagonMaze.gif)
