...
/**
 * The always-present "Give feedback" affordance, mounted once by
 * `PortfolioPage` and only on deployments that ship it (see
 * `lib/feedback/enabled.ts`).
 *
